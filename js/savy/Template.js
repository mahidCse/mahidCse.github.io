var Template = {
    ...
    init: function() {
        if (!this._inited) {
            ...
            b && (this._applyLayoutTitlePatch(), $(".layout-anti-scroll").removeClass("layout-anti-scroll--active")), this.menu.init({
                on: {
        ...
        }), this.shortcodes.init(), this.initResume(), this.initPortfolio(), this.initBlog(), this.initGoogleMap(), this.initContactFormValidation(), this._inited || (this._inited = !0)
    },
    initResume: function() {
            ...
            a.on("submit", function(c) {
                ...
                return $.each(h, function(a, b) {
                    ...
                    complete: function(c, g) {
                        ...
                        if (b(h.errors || {}), "success" == g && h.success) f.addClass(d).text(h.message || "Your message was sent successfully. Thanks."), a.trigger("reset");
                        else {
    ...
    _initAjaxPagesLoading: function(a, b) {
        a && !this.menu.isFileProtocol() && (b || (b = "a"), $(b, a).click(function(a) {
            a.which > 1 || a.ctrlKey || (a.preventDefault(), document.location.hash = "#" + $(this).attr("href"))
        }))
    },
...
Template.menu = {
    ...
    init: function(a) {
        if (!this._inited) {
            this._inited = !0, a && (a.on && ($(this).on(a.on), delete a.on), $.isEmptyObject(a) || $.extend(this, a)), this._initMainMenu(), this._initMobileMenu();
            var b = this;
    ...
    _restoreActiveCurrentPageState: function() {
        ...
        }(!a || a.length < 1) && (a = b.filter("." + this.currenMenuItemClass), a.length < 1 && (a = b.first()), a.trigger("activate", {
            noAnimation: !0
        }))
    },
    ...
    if (window.ga) {
        ...
        b && (b = b.replace(/^Savvy - /i, "") + " - Ajax"), ga("send", "pageview", {
            page: a,
            title: b
        })
    }
